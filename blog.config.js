...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小花的工具箱', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爸妈也会用的工具箱', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xh1024.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '软件, 工具', // 网站关键词 英文逗号隔开
